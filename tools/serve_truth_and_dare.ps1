...
$relativeProductUrl = '/app/encounter_cards_v16.html'
$productPath = Join-Path $projectRoot 'app/encounter_cards_v16.html'
...
if (-not (Test-Path -LiteralPath $productPath -PathType Leaf)) {
    throw 'Encounter Cards v16 is missing. Run tools/build_v16.ps1 first.'
}
