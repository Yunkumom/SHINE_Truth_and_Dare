...
Historical note: this completed plan predates the later approved top-level governance contract. Current canonical paths are defined in `2026-07-19-create-top-level-governance-directories.md`.
