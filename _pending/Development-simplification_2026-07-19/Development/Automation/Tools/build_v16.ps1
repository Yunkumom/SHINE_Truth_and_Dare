...
$sourcePath = Join-Path $projectRoot 'Apps/Standalone/encounter_cards_v15.html'
$outputPath = Join-Path $projectRoot 'Apps/Standalone/encounter_cards_v16.html'
...
if ($outputAlreadyMatches) {
    Write-Host 'v16 already matches the deterministic build output; module assets are complete.' -ForegroundColor Cyan
    exit 0
}
