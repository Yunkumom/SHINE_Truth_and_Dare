...
Truth and Dare is the governed repository for **Encounter Cards**, a bilingual, iPhone-first conversation card game. Encounter Cards v29 is the current maintained release; v15–v29 remain immutable standalone references after publication.

Truth and Dare 是雙語、iPhone 優先的對話卡牌遊戲 **相遇卡 Encounter Cards**。v29 是目前維護版本；v15–v29 發布後均保留為不可變 standalone 參考版本。

## Start / 開始

- Double-click `Open Truth and Dare.cmd`; it serves and opens the current v29 release at `127.0.0.1:8765`.
- Public site: `https://yunkumom.github.io/SHINE_Truth_and_Dare/` (available after the Pages workflow completes).
- Current authored source: `Development/Source/Main-App-v29/src/`
- Current verified PWA build: `Development/Source/Main-App-v29/dist/`
- Current standalone release: `Apps/Standalone/encounter_cards_v29.html`
- Public GitHub Pages artifact: `Apps/Public-Web/v12/`
...
├── Development/   # Preserved earlier lines plus current v29 source, tools, tests, and contracts
...
Existing v15–v29 outputs are immutable after release. Later product changes require a new version rather than overwriting a released version.
