...
Truth and Dare is the governed repository for **Encounter Cards**, a bilingual, iPhone-first conversation card game. Encounter Cards v24 is the current maintained release; v15–v23 remain immutable standalone references.

Truth and Dare 是雙語、iPhone 優先的對話卡牌遊戲 **相遇卡 Encounter Cards**。v24 是目前維護版本；v15–v23 保留為不可變 standalone 參考版本。

## Start / 開始

- Double-click `Open Truth and Dare.cmd`; it serves and opens the current v24 release at `127.0.0.1:8765`.
- Public site: `https://yunkumom.github.io/SHINE_Truth_and_Dare/` (available after the Pages workflow completes).
- Current authored source: `Development/Source/Main-App-v24/src/`
- Current verified PWA build: `Development/Source/Main-App-v24/dist/`
...
Existing v15–v24 outputs are immutable. Product changes after v24 require v25 rather than overwriting a released version.
