...
Truth and Dare is the governed repository for **Encounter Cards**, a bilingual, iPhone-first conversation card game. Encounter Cards v23 is the current maintained release; v15–v22 remain immutable standalone references.

Truth and Dare 是雙語、iPhone 優先的對話卡牌遊戲 **相遇卡 Encounter Cards**。v23 是目前維護版本；v15–v22 保留為不可變 standalone 參考版本。

## Start / 開始

- Double-click `Open Truth and Dare.cmd`; it serves and opens the current v23 release at `127.0.0.1:8765`.
- Public site: `https://yunkumom.github.io/SHINE_Truth_and_Dare/` (available after the Pages workflow completes).
- Current authored source: `Development/Source/Main-App-v23/src/`
- Current verified PWA build: `Development/Source/Main-App-v23/dist/`
...
├── Development/   # Preserved earlier lines plus current v23 source, tools, tests, and contracts
...
Existing v15–v23 outputs are immutable. Product changes after v23 require v24 rather than overwriting a released version.
...
- Eighteen v23 deity artworks, each with a precise coloured Taiwan silhouette inside the visible crop; hold for 600 ms to reveal the matching canonical outline for 3 seconds.
