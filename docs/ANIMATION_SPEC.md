...
This document records confirmed product intent. The v15 package contains drag/motion and export-related code, but the complete gesture sequence has not yet been interactively regression-tested in this repository.
