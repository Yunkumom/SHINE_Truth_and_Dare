...
export default function LayoutEditor({ open, history, onHistoryChange, screen, onScreenChange, selectedBlock, onSelectBlock, onClose, snap = true, onSnapChange }: LayoutEditorProps) {
  ...
  return <aside className="layout-editor" role="dialog" aria-label="Layout editor">
    <header><div><b>版面編輯器</b><small>LAYOUT EDITOR · V22</small></div><button type="button" onClick={onClose} aria-label="Close layout editor">×</button></header>
