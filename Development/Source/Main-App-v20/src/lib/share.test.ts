...
const composition: EncounterComposition = {
  ...
  artwork: { id: 'art', deityId: 'mazu', zhName: '媽祖', enName: 'Mazu', src: 'art.webp', hiddenTaiwan: 'lantern' },
  blessing: { id: 'blessing', zh: '中文祝福', en: 'English blessing' },
}

describe('v20 keepsake content', () => {
  ...
  it('downloads the PNG on desktop when Web Share is unavailable', async () => {
    ...
    const file = new File(['png'], 'encounter-card-v20.png', { type: 'image/png' })
