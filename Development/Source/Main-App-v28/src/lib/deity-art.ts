...
import baoshengApothecarySrc from '../assets/deities/baosheng-apothecary-wide-taiwan-safe-v28.png'
...
export const DEITY_ART: readonly ArtworkVariant[] = [
  ...
  { id: 'baosheng-apothecary', deityId: 'baosheng-dadi', zhName: '保生大帝', enName: 'Baosheng Dadi', src: baoshengApothecarySrc, hiddenTaiwan: 'turquoise medicine mortar', portraitFocus: { x: 50, y: 34 }, taiwanHotspot: { x: 52, y: 68, scale: .38, rotation: 8, color: '#22c4bd', accent: '#fff1a8' } },
