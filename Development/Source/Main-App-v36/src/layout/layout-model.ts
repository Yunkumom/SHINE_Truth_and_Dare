...
const STORAGE_KEY = 'encounter-layout-v36'
...
export const DEFAULT_LAYOUT: LayoutDocument = {
  ...
  screens: {
    setup: {
      ...
      hero: block(18, 72, 394, 142),
      fields: block(18, 224, 394, 184),
      levels: block(18, 418, 394, 124),
      modes: block(18, 552, 394, 158),
      begin: block(18, 838, 394, 76, 6),
    },
    game: {
      header: block(0, 0, 430, 62, 5),
      toolbar: block(16, 68, 398, 42, 4),
      card: block(14, 116, 402, 590, 3),
      actions: block(14, 858, 402, 58, 6),
    },
    keepsake: {
      card: block(14, 68, 402, 562, 2),
      header: block(25, 76, 380, 60, 3),
      artwork: block(25, 138, 380, 304, 3),
