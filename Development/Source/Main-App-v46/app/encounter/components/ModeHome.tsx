...
export default function ModeHome({ language, onChooseKeepsake, onChooseTruthOrDare }: ModeHomeProps) {
  ...
  return <section className="mode-home-canvas" aria-label="選擇模式 · Choose an experience">
    <header className="mode-home-header">
      <div className="mode-home-brand"><span aria-hidden="true">✦</span><b>相遇卡<small>ENCOUNTER CARDS · V46</small></b></div>
      <span className="mode-home-step">01 / 02</span>
    </header>
