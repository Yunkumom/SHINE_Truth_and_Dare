...
describe('v30 deity card artwork', () => {
  ...
  it('keeps every hidden Taiwan locator inside the visible card crop', () => {
    ...
    expect(DEITY_ART.every(artwork => artwork.src.includes('safe-v30'))).toBe(true)
  ...
  it('uses the regenerated portrait-safe Baosheng apothecary master and aligned central locator', () => {
    ...
    expect(artwork?.src).toContain('baosheng-apothecary-safe-v30')
