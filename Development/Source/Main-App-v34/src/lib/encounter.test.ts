...
const artworks: ArtworkVariant[] = [
  { id: 'mazu-calm', deityId: 'mazu', zhName: '媽祖', enName: 'Mazu', src: 'mazu.webp', hiddenTaiwan: 'sleeve embroidery', portraitFocus: { x: 50, y: 22 }, taiwanHotspot: { x: 30, y: 30, scale: 1, rotation: 0, color: '#24c9c3', accent: '#ff765f' } },
  { id: 'mazu-sailing', deityId: 'mazu', zhName: '媽祖', enName: 'Mazu', src: 'mazu-sailing.webp', hiddenTaiwan: 'lantern carving', portraitFocus: { x: 50, y: 22 }, taiwanHotspot: { x: 40, y: 50, scale: .8, rotation: 8, color: '#54d7b2', accent: '#e8493f' } },
  { id: 'guanyin-lotus', deityId: 'guanyin', zhName: '觀音', enName: 'Guanyin', src: 'guanyin.webp', hiddenTaiwan: 'lotus ornament', portraitFocus: { x: 50, y: 22 }, taiwanHotspot: { x: 60, y: 70, scale: .7, rotation: -8, color: '#7f65e8', accent: '#46d9e0' } },
]
