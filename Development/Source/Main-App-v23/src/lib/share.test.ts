...
const composition: EncounterComposition = {
  ...
  artwork: { id: 'art', deityId: 'mazu', zhName: '媽祖', enName: 'Mazu', src: 'art.webp', hiddenTaiwan: 'lantern', taiwanHotspot: { x: 50, y: 50, scale: 1, rotation: 0, color: '#24c9c3', accent: '#ff765f' } },
  blessing: { id: 'blessing', zh: '中文祝福', en: 'English blessing' },
}

describe('v23 keepsake content', () => {
  ...
  it('downloads the PNG on desktop when Web Share is unavailable', async () => {
    ...
    const file = new File(['png'], 'encounter-card-v23.png', { type: 'image/png' })
