...
describe('Encounter Cards setup', () => {
  ...
  it('renders the approved entrance hierarchy as v23 with Begin separated at the bottom', () => {
    render(<App />)
    expect(screen.getByText('ENCOUNTER CARDS · V23')).toBeInTheDocument()
  ...
  it('supports desktop mouse clicks through setup, draw, and next-card controls', async () => {
    ...
    expect(screen.getByTestId('editable-card')).toHaveStyle({ width: '402px', height: '562px' })
