    ...
    {visible && <>
      <div className="taiwan-locator" data-testid="taiwan-locator" style={hotspotStyle} aria-hidden="true">
        <svg viewBox={TAIWAN_VIEWBOX} focusable="false">
          <path className="taiwan-coastline-glow" data-testid="taiwan-shape" data-canonical-shape="taiwan-v26" d={TAIWAN_PATH} />
          <path className="taiwan-coastline-crisp" data-testid="taiwan-shape" data-canonical-shape="taiwan-v26" d={TAIWAN_PATH} />
        </svg>
      </div>
