...
Assert-V31Condition ($server -match 'encounter_cards_v35\.html' -and $server -match 'encounter-release.*V35') 'Current desktop launcher moved forward without modifying v31'
Assert-V31Condition ($workflow -match 'Main-App-v35' -and $workflow -match 'Public-Web/v18') 'Current GitHub Pages workflow moved forward without modifying Public Web v14'
