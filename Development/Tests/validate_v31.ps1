...
Assert-V31Condition ($server -match 'encounter_cards_v31\.html' -and $server -match 'encounter-release.*V31') 'Desktop launcher serves and verifies v31'
Assert-V31Condition ($workflow -match 'Main-App-v31' -and $workflow -match 'Public-Web/v14') 'GitHub Pages workflow builds and publishes v31 as Public Web v14'
