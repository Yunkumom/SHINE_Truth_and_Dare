...
Assert-V38Condition ($workflow -match 'Main-App-v39' -and $workflow -match 'Public-Web/v22' -and $workflow -match 'node-version: 26') 'GitHub Pages builds v38 on Node 26 and publishes Public Web v21'
