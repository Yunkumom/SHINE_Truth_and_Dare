...
$requiredDirectories += @('Apps/Public-Web/v17', 'Apps/Public-Web/v18', 'Apps/Public-Web/v19', 'Apps/Public-Web/v20', 'Apps/Public-Web/v21', 'Apps/Public-Web/v22', 'Assets/Zodiac/Taiwan/v34-local-stories-masters', 'Development/Source/Main-App-v34', 'Development/Source/Main-App-v35', 'Development/Source/Main-App-v36', 'Development/Source/Main-App-v37', 'Development/Source/Main-App-v38', 'Development/Source/Main-App-v39', 'Development/Source/Main-App-v46', 'Development/Source/Public-Web/v17', 'Development/Source/Public-Web/v18', 'Development/Source/Public-Web/v19', 'Development/Source/Public-Web/v20', 'Development/Source/Public-Web/v21', 'Development/Source/Public-Web/v22', '_pending/v34-generated-development-state_2026-07-29', '_pending/v34-preverification-build_2026-07-29', '_pending/v35-generated-development-state_2026-07-29', '_pending/Encounter_Cards_v11_Source_2026-07-30', '_pending/v36-generated-development-state_2026-07-30', '_pending/v36-preverification-build_2026-07-30', '_pending/v37-generated-development-state_2026-07-30', '_pending/v46-generated-development-state_2026-08-16')
...
if (Test-Path -LiteralPath $developmentReadmePath -PathType Leaf) {
    ...
    $retainedFiles = Get-ChildItem -LiteralPath $developmentRoot -Recurse -Force -File | Where-Object {
        ...
        $_.FullName -notmatch '[\\/]Source[\\/]Main-App-v46[\\/]' -and
    ...
    foreach ($annotation in @('Source/Main-App-v46/','Source/Main-App-v46/app/encounter/','Source/Main-App-v46/public/v46/','Source/Main-App-v46/scripts/finalize-encounter.mjs','Tests/validate_v46.mjs')) {
        Assert-StructureCondition ($developmentReadme.Contains($annotation)) "Development README annotates v46 path: $annotation"
    }
}
