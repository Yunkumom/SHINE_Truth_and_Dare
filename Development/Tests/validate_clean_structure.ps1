...
$requiredDirectories = @(
    'Apps/Standalone', 'Apps/Public-Web/v2', 'Apps/Public-Web/v3', 'Apps/Public-Web/v4', 'Apps/Public-Web/v5', 'Assets/Catalog', 'Assets/Deities', 'Assets/Deities/v20-variants',
    'Development/Source/Main-App-v18', 'Development/Source/Main-App-v19', 'Development/Source/Main-App-v20', 'Development/Source/Main-App-v21', 'Development/Source/Main-App-v22', 'Development/Source/Public-Web/v2', 'Development/Source/Public-Web/v3', 'Development/Source/Public-Web/v4', 'Development/Source/Public-Web/v5', 'Development/Automation/Scripts', 'Development/Automation/Tools',
...
$requiredFiles = @(
    ...
    'Development/Source/Main-App-v18/package.json', 'Development/Source/Main-App-v19/package.json', 'Development/Source/Main-App-v20/package.json', 'Development/Source/Main-App-v21/package.json', 'Development/Source/Main-App-v22/package.json', 'Development/Source/Public-Web/v2/README.md', 'Development/Source/Public-Web/v3/README.md', 'Development/Source/Public-Web/v4/README.md', 'Development/Source/Public-Web/v5/README.md', 'Development/Automation/Tools/serve_truth_and_dare.ps1',
...
$expectedSourceEntries = @('Main-App-v18','Main-App-v19','Main-App-v20','Main-App-v21','Main-App-v22','Public-Web')
Assert-StructureCondition ($sourceEntries.Count -eq $expectedSourceEntries.Count -and @($sourceEntries | Where-Object { $_ -notin $expectedSourceEntries }).Count -eq 0) 'Development Source contains preserved v18-v21, active v22, and versioned Public Web recipes'
...
if (Test-Path -LiteralPath $developmentReadmePath -PathType Leaf) {
    ...
    $retainedFiles = Get-ChildItem -LiteralPath $developmentRoot -Recurse -Force -File | Where-Object {
        ...
        $_.FullName -notmatch '[\\/]Source[\\/]Public-Web[\\/]v[2345][\\/]'
    }
