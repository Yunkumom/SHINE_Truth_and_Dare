...
Assert-V32Condition ($server -match 'encounter_cards_v36\.html' -and $server -match 'encounter-release.*V36') 'Desktop launcher advances to v36 without modifying v32'
Assert-V32Condition ($workflow -match 'Main-App-v36' -and $workflow -match 'Public-Web/v19') 'GitHub Pages advances to v36 and Public Web v19'
