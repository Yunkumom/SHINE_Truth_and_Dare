...
Assert-V37Condition ($workflow -match 'Main-App-v38' -and $workflow -match 'Public-Web/v21' -and $workflow -match 'node-version: 26') 'GitHub Pages advances to v38 and Public Web v21 without modifying v37'
