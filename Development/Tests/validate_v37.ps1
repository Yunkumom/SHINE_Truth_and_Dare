...
Assert-V37Condition ($workflow -match 'Main-App-v37' -and $workflow -match 'Public-Web/v20' -and $workflow -match 'node-version: 26') 'GitHub Pages builds v37 on Node 26 and publishes Public Web v20'
