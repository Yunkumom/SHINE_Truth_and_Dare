...
Assert-V30Condition ($server -match 'encounter_cards_v33\.html' -and $server -match 'encounter-release.*V33') 'Desktop launcher advances to the current v33 release'
Assert-V30Condition ($workflow -match 'Main-App-v33' -and $workflow -match 'Public-Web/v16') 'GitHub Pages workflow advances to v33 and Public Web v16'
