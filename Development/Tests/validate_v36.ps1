...
Assert-V36Condition ($server -match 'encounter_cards_v36\.html' -and $server -match 'encounter-release.*V36') 'Desktop launcher serves and verifies v36'
Assert-V36Condition ($workflow -match 'Main-App-v36' -and $workflow -match 'Public-Web/v19' -and $workflow -match 'node-version: 26') 'GitHub Pages builds v36 on Node 26 and publishes Public Web v19'
