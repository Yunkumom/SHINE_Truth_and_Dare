...
$requiredFiles = @(
    ...
    'Development/Source/Public-Web/v18/README.md', 'Development/Source/Public-Web/v19/README.md', 'Development/Source/Public-Web/v20/README.md', 'Development/Source/Public-Web/v21/README.md',
