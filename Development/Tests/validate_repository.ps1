...
$requiredFiles = @(
    ...
    'Apps/Public-Web/v2/index.html', 'Apps/Public-Web/v3/index.html', 'Apps/Public-Web/v4/index.html', 'Apps/Public-Web/v5/index.html', 'Apps/Public-Web/v6/index.html', 'Apps/Public-Web/v7/index.html', 'Apps/Public-Web/v8/index.html', 'Apps/Public-Web/v9/index.html', 'Apps/Public-Web/v10/index.html', 'Apps/Public-Web/v11/index.html', 'Apps/Public-Web/v12/index.html', 'Apps/Public-Web/v13/index.html', 'Apps/Public-Web/v14/index.html', 'Apps/Public-Web/v15/index.html', 'Apps/Public-Web/v16/index.html', 'Apps/Public-Web/v17/index.html',
    ...
    'Development/Tests/validate_clean_structure.ps1', 'Development/Tests/validate_v18.ps1', 'Development/Tests/validate_v19.ps1', 'Development/Tests/validate_v20.ps1', 'Development/Tests/validate_v21.ps1', 'Development/Tests/validate_v22.ps1', 'Development/Tests/validate_v23.ps1', 'Development/Tests/validate_v24.ps1', 'Development/Tests/validate_v25.ps1', 'Development/Tests/validate_v26.ps1', 'Development/Tests/validate_v27.ps1', 'Development/Tests/validate_v28.ps1', 'Development/Tests/validate_v29.ps1', 'Development/Tests/validate_v30.ps1', 'Development/Tests/validate_v31.ps1', 'Development/Tests/validate_v32.ps1', 'Development/Tests/validate_v33.ps1', 'Development/Tests/validate_v34.ps1', 'Development/Tests/validate_repository.ps1',
