...
Assert-V35Condition ($server -match 'encounter_cards_v35\.html' -and $server -match 'encounter-release.*V35') 'Desktop launcher serves and verifies v35'
Assert-V35Condition ($workflow -match 'Main-App-v35' -and $workflow -match 'Public-Web/v18') 'GitHub Pages builds v35 and publishes Public Web v18'
