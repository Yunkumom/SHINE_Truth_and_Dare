...
Assert-V29Condition ($server -match 'encounter_cards_v34\.html' -and $server -match 'encounter-release.*V34') 'Current desktop launcher moved forward without modifying v29'
Assert-V29Condition ($workflow -match 'Main-App-v34' -and $workflow -match 'Public-Web/v17') 'Current GitHub Pages workflow moved forward without modifying Public Web v12'
