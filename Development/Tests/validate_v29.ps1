...
Assert-V29Condition ($server -match 'encounter_cards_v37\.html' -and $server -match 'encounter-release.*V37') 'Current desktop launcher moved to v37 without modifying v29'
Assert-V29Condition ($workflow -match 'Main-App-v39' -and $workflow -match 'Public-Web/v22') 'Current GitHub Pages workflow moved to v37 and Public Web v20 without modifying Public Web v12'
