...
Assert-V29Condition ($server -match 'encounter_cards_v33\.html' -and $server -match 'encounter-release.*V33') 'Current desktop launcher moved forward without modifying v29'
Assert-V29Condition ($workflow -match 'Main-App-v33' -and $workflow -match 'Public-Web/v16') 'Current GitHub Pages workflow moved forward without modifying Public Web v12'
