...
Assert-V29Condition ($server -match 'encounter_cards_v32\.html' -and $server -match 'encounter-release.*V32') 'Current desktop launcher moved forward without modifying v29'
Assert-V29Condition ($workflow -match 'Main-App-v32' -and $workflow -match 'Public-Web/v15') 'Current GitHub Pages workflow moved forward without modifying Public Web v12'
