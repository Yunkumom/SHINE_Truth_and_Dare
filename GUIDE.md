# Truth or Dare Directory Guide / 真心話大冒險資料夾指南

This is the canonical repository map. Active Development contains preserved earlier lines, the current v46 Sites/Vinext line, and files required to run, understand, and validate them.

本檔是正式 repository 地圖。作用中的 Development 保留較早版本與目前 v46 Sites／Vinext line，以及執行、理解與驗證所需的檔案。
...
| `Apps/Public-Web/v21/` | Preserved immutable v38 Pages artifact with one-viewport mobile fit and reliable artwork adjustment. / 保留的不可變 v38 手機單頁適配與可靠照片調整 Pages 成品。 |
| `Apps/Public-Web/v22/` | Current immutable v39 Pages artifact with full-width mobile modes and direct keepsake creation. / 目前不可變 v39 全寬手機模式與直接紀念卡 Pages 成品。 |
...
| `Assets/Zodiac/` | Country- and culture-specific zodiac assets and governance. / 依國家與文化分類的星座素材及治理。 |
...
| `Development/` | Current v46 source, preserved releases, automation, validation, and product contracts. / 目前 v46 source、保留 releases、自動化、驗證與產品合約。 |
...
| `_pending/Encounter_Cards_v11_Source_2026-07-30/` | Preserved mobile ChatGPT Work import after its governed v36 integration. / 完成 v36 受治理整合後保留的手機 ChatGPT Work 原始資料。 |
| `_pending/v36-generated-development-state_2026-07-30/` | Recoverable local v36 dependencies and TypeScript caches. / 可回復的 v36 本機依賴與 TypeScript cache。 |
| `_pending/v37-generated-development-state_2026-07-30/` | Recoverable local v37 dependencies and TypeScript caches. / 可回復的 v37 本機依賴與 TypeScript cache。 |
| `_pending/v36-preverification-build_2026-07-30/` | Unpublished v36 candidate retained before final accessibility and language-fallback corrections. / 最終無障礙與語言備援修正前保留的未發布 v36 候選。 |
...
| `Open Truth and Dare.cmd` | One-click Windows v46 launcher with locked dependency restore. / Windows v46 一鍵啟動器，含鎖定依賴還原。 |
...
| `Development/Source/Main-App-v24/` | Preserved source with the Natural Earth-derived transparent dual-stroke Taiwan coastline reveal. / 保留的 source，使用 Natural Earth 衍生的透明雙線台灣海岸線揭示。 |
| `Development/Source/Main-App-v25/` | Preserved source with desktop workspace and portrait-safe focal cropping. / 保留的桌面工作區與人像安全焦點裁切 source。 |
...
| `Development/Source/Main-App-v28/` | Preserved v28 source with the wide Baosheng safe crop and aligned locator. / 保留的 v28 保生大帝安全構圖與定位 source。 |
| `Development/Source/Public-Web/v11/` | v28 to Public Web v11 recipe. / v28 至公開 v11 產製說明。 |
| `Development/Source/Main-App-v29/` | Preserved v29 source with independently adjustable question and blessing typography. / 保留的 v29 可獨立調整問題與祝福字級 source。 |
| `Development/Source/Public-Web/v12/` | v29 to Public Web v12 recipe. / v29 至公開 v12 產製說明。 |
| `Development/Source/Main-App-v30/` | Preserved v30 source with all 18 regenerated portrait-safe artworks and aligned Taiwan locators. / 保留的 v30 全 18 張重生成人像安全圖與台灣定位 source。 |
| `Development/Source/Public-Web/v13/` | v30 to Public Web v13 recipe. / v30 至公開 v13 產製說明。 |
| `Development/Source/Main-App-v31/` | Preserved v31 source with a unified milk-tea setup, editor, desktop workbench, and unclipped bilingual headings. / 保留的 v31 淡奶茶入口、編輯器、桌面工作區與不裁切雙語標題 source。 |
| `Development/Source/Public-Web/v14/` | v31 to Public Web v14 recipe. / v31 至公開 v14 產製說明。 |
| `Development/Source/Main-App-v32/` | Preserved authored source with separate desktop Settings/Test modes, mobile play-only behavior, stable opt-in direct manipulation, safe text, and governed artwork choice. / 保留的 v32 人工 source，含桌面設定／測試模式、手機純遊玩、穩定的選用拖拉、安全文字及受治理卡面選擇。 |
| `Development/Source/Public-Web/v15/` | v32 to Public Web v15 recipe. / v32 至公開 v15 產製說明。 |
| `Development/Source/Main-App-v33/` | Preserved authored source with 30 governed artworks, Taiwan zodiac data, question packs, and independent exact choices. / 保留的 v33 人工 source，含 30 張受治理卡面、台灣星座資料、問題包與獨立指定。 |
...
| `Development/Source/Main-App-v35/` | Preserved authored source with the entrance menu, full-card library, three-card virtualization, and independent artwork selection. / 保留的 v35 人工 source，含入口清單、完整卡庫、三卡虛擬化與獨立卡面選擇。 |
...
| `Development/Source/Main-App-v38/` | Preserved authored source with complete mobile viewport fit and reliable per-artwork adjustment. / 保留的 v38 人工 source，含完整手機單頁適配與可靠的逐圖調整。 |
| `Development/Source/Public-Web/v21/` | v38 to Public Web v21 recipe. / v38 至公開 v21 產製說明。 |
| `Development/Source/Main-App-v39/` | Preserved authored source with full-width mobile reflow, mode selection, and direct keepsake creation; latest standalone fallback. / 保留的 v39 人工 source，含全寬手機排版、模式選擇與直接紀念卡；為最新 standalone 備援。 |
| `Development/Source/Public-Web/v22/` | v39 to Public Web v22 recipe. / v39 至公開 v22 產製說明。 |
| `Development/Source/Main-App-v46/` | Current multi-route Sites/Vinext source with generated `/v46/` PWA, mobile surface, desktop studio, 42 artworks, and 62-question SHINE book. / 目前多路由 Sites／Vinext source，含生成的 `/v46/` PWA、手機介面、電腦工作室、42 張 artwork 與 62 題 SHINE 題庫。 |
...
| `_pending/v33-preverification-build_2026-07-28/` | Unpublished v33 browser-QA candidates retained as evidence; never publish them. / v33 瀏覽器驗證中的未發布候選版本，僅供證據且不得發布。 |
...
| `Development/Automation/Scripts/` | Versioned v18–v39 PWA, standalone, and public-release builders. / 版本化 v18–v39 建置器。 |
| `Development/Automation/Tools/` | Loopback-only v39 desktop server helper. / 僅限本機的 v39 desktop server。 |
| `Development/Tests/` | v18–v39 immutable-release validators plus the v46, structure, and repository contracts. / v18–v39 不可變 release validators，以及 v46、結構與 repository 合約。 |
...
# Restore dependencies and work on current v46 source
