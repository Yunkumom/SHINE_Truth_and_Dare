...
- Active authored source: `Development/Source/Main-App-v26/src/`
- Verified PWA output: `Development/Source/Main-App-v26/dist/`
- Current standalone release: `Apps/Standalone/encounter_cards_v26.html`
- Public release artifact: `Apps/Public-Web/v9/`
- Desktop URL: `http://127.0.0.1:8765/Apps/Standalone/encounter_cards_v26.html`
- Public URL: `https://yunkumom.github.io/SHINE_Truth_and_Dare/`
- Repository: `https://github.com/Yunkumom/SHINE_Truth_and_Dare`
- v15–v26 standalone releases are immutable after release.
...
Run the physical iPhone v26 regression across layout editing, swipe/flip, all 18 Taiwan reveals, presentation controls, contact toggles, download/Share Sheet, installation, and offline update. Any product behavior change after v26 must use a new versioned source and release.
