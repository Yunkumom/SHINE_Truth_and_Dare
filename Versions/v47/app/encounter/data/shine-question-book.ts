...
const questions: ShineQuestion[] = [
  ...
  { number: 63, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'THE TROLLEY PROBLEM', zhTitle: '列車難題', en: 'A runaway trolley will hit five people unless you pull a lever that redirects it toward one person. Would you pull it, and what principle guides your choice?', zh: '一輛失控列車即將撞上五個人；你可以拉下拉桿，讓它改道撞上一個人。你會拉嗎？你的選擇依據是什麼？' },
  { number: 64, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'SELF-SACRIFICE', zhTitle: '你會犧牲自己嗎？', en: 'In an extreme rescue, sacrificing yourself would certainly save someone you love. Would you do it, and would your answer change for a stranger?', zh: '在極端救援中，犧牲自己一定能救下你愛的人。你會這麼做嗎？如果對方是陌生人，答案會改變嗎？' },
  { number: 65, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'THE LAST LIFEBOAT SEAT', zhTitle: '救生艇最後一席', en: 'A lifeboat has one seat left, but two people need it: a young stranger and an older person who supports a family. How would you decide?', zh: '救生艇只剩一個位置，但有兩人需要它：一位年輕陌生人，以及一位養活全家的年長者。你會如何決定？' },
  { number: 66, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'ONE LOVED PERSON OR FIVE STRANGERS', zhTitle: '摯愛或五位陌生人', en: 'If you could rescue either one person you love or five strangers, but not both, whom would you choose and why?', zh: '如果你只能救一位摯愛或五位陌生人，無法兩邊都救，你會選誰？為什麼？' },
  { number: 67, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'TRUTH OR COMFORT', zhTitle: '真相或安慰', en: 'If a painful truth would change nothing but a comforting lie would let someone live peacefully, which would you tell?', zh: '如果殘酷的真相無法改變任何事，而善意的謊言能讓一個人平靜生活，你會選擇說哪一個？' },
  { number: 68, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'STEALING THE MEDICINE', zhTitle: '為救人偷藥', en: 'If the only way to save a loved one were to steal unaffordable medicine, would doing so be morally justified?', zh: '如果拯救摯愛的唯一方法，是偷走你無力負擔的藥物，這樣做在道德上可以被合理化嗎？' },
  { number: 69, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'JUSTICE OR MERCY', zhTitle: '正義或寬恕', en: 'When someone sincerely regrets causing serious harm, should justice focus more on punishment or on giving them a path back?', zh: '當一個人真心後悔自己造成的嚴重傷害時，正義應更重視懲罰，還是給他一條回來的路？' },
  { number: 70, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'LOYALTY OR HONESTY', zhTitle: '忠誠或誠實', en: 'If telling the truth would seriously hurt a close friend but staying silent would harm someone else, where should your loyalty end?', zh: '如果說出真相會嚴重傷害好友，但保持沉默又會傷害另一個人，你的忠誠應該到哪裡為止？' },
  { number: 71, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'MEMORY AND IDENTITY', zhTitle: '記憶與自我是誰', en: 'If all your memories were copied perfectly into another body, which person would be the real you?', zh: '如果你的所有記憶都被完美複製到另一個身體裡，哪一個人才是真正的你？' },
  { number: 72, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'THE PERFECT SIMULATION', zhTitle: '完美虛擬人生', en: 'Would you choose a perfectly happy simulated life if you knew none of its relationships or achievements were real?', zh: '如果你明知其中的關係與成就都不是真實的，你仍會選擇進入一個永遠幸福的完美虛擬人生嗎？' },
  { number: 73, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'IMMORTALITY', zhTitle: '永生的代價', en: 'If you could live forever while everyone else aged normally, would immortality be a gift or a burden?', zh: '如果你可以永遠活著，而其他人仍正常老去，永生對你而言會是禮物還是負擔？' },
  { number: 74, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'FREE WILL', zhTitle: '自由意志', en: 'Do you believe people truly choose who they become, or are most choices shaped by biology, upbringing, and circumstance?', zh: '你相信人真的能自由選擇成為誰，還是大多數選擇其實都被天性、成長與環境塑造？' },
  { number: 75, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'DO YOU BELIEVE IN GHOSTS?', zhTitle: '你相信有鬼嗎？', en: 'Do you believe ghosts or spirits exist, and what kind of experience or evidence could change your mind?', zh: '你相信有鬼或靈魂存在嗎？什麼樣的經驗或證據可能讓你改變想法？' },
  { number: 76, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'A NIGHT IN A HAUNTED HOUSE', zhTitle: '住進鬧鬼的房子', en: 'Would you spend one night alone in a famously haunted house for a life-changing reward, and what would frighten you most?', zh: '如果報酬足以改變人生，你願意獨自在著名的鬧鬼房子住一晚嗎？你最害怕的會是什麼？' },
  { number: 77, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'A CONSCIOUS MACHINE', zhTitle: '有意識的機器', en: 'If a machine convincingly said it could feel pain and fear death, what would it need to prove before you believed it deserved rights?', zh: '如果一台機器令人信服地表示自己會感到痛苦並害怕死亡，它需要證明什麼，你才會相信它值得擁有權利？' },
  { number: 78, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'GOOD WHEN NO ONE KNOWS', zhTitle: '無人知道的善行', en: 'If no one could ever know about your good deed—not even the person helped—would doing it still feel equally meaningful?', zh: '如果永遠沒有人知道你做過的善事，連受幫助的人也不知道，你仍會覺得它同樣有意義嗎？' },
  { number: 79, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'INTENTION OR CONSEQUENCE', zhTitle: '動機或結果', en: 'Which matters more when judging an action: the person’s intention or the actual consequences, and why?', zh: '評價一個行為時，行動者的動機與實際造成的結果，哪一個更重要？為什麼？' },
  { number: 80, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'FORGIVENESS WITHOUT AN APOLOGY', zhTitle: '沒有道歉的原諒', en: 'Can forgiving someone who never apologized be an act of freedom, or does it excuse what they did?', zh: '原諒一個從未道歉的人，可以是一種讓自己自由的選擇，還是等於替他的行為開脫？' },
  { number: 81, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'THE LAST MESSAGE', zhTitle: '最後一則訊息', en: 'If you could send one final message that every person in the world would hear, what would you say?', zh: '如果你能送出最後一則訊息，讓全世界每個人都聽見，你會說什麼？' },
  { number: 82, depth: 'three', mode: 'truth', kind: 'question', enTitle: 'RESET HUMANITY', zhTitle: '重啟人類文明', en: 'If you could restart human civilization with one harmful trait removed, what would you remove, and what unintended cost might follow?', zh: '如果你能重啟人類文明並移除一種有害特質，你會移除什麼？這可能帶來哪些意想不到的代價？' },
]
